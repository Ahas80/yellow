...
FILE_MLST_CANONICAL <- file.path(DIR_MLST, "mlst_with_meta.csv")
...
FILE_OVERVIEW_XLSX <- file.path(DIR_ROOT, "OVERVIEW E.coli batch 1-6 - CLEAN.xlsx")
...
#' Load the overview spreadsheet (OVERVIEW E.coli batch 1-6 - CLEAN.xlsx)
